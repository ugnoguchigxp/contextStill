...
export function LlmResourcesDomain({
  dashboard,
}: LlmResourcesDomainProps) {
  return (
    <section className="overview-domain-section accent-violet">
      ...
      <div className="flex flex-col justify-between h-full py-1 gap-4">
        ...
        <div className="flex flex-col gap-2">
          <span className="text-slate-500 text-[12px] font-semibold uppercase tracking-wider mb-1.5">LLM Activity Sources (30d)</span>
          {(() => {
