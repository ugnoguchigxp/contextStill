...
| [DB Session And Repository Decoupling Plan](db-session-repository-decoupling-plan.md) | Implementation plan for decoupling repositories from DB connection singletons and preparing for SQLite write coordination |
...
| [Negative Knowledge Execution Plan](negative-knowledge-execution-plan.md) | Implementation-ready slice plan for adding Negative Knowledge without a dedicated negative coverage table |
