...
- Primary MCP workflow tools for `initial_instructions`, `context_compile`, and `compile_eval`, with supplemental MCP lookup, diagnostics, and candidate-registration tools.
