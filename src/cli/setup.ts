...
const setupLocaleText: Record<SupportedLocale, SetupLocaleText> = {
  ja: {
...
async function buildSetupSummary(options: SetupOptions): Promise<SetupSummary> {
