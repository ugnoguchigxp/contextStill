...
export const overviewKnowledgeAssetsDomainSchema = z.object({
  ...
  kpis: overviewDashboardKpisSchema.pick({
    ...
    sourceEvidenceLinkedKnowledge: true,
    sourceEvidenceUnlinkedKnowledge: true,
    originLinkedKnowledge: true,
    originUnlinkedKnowledge: true,
    provenanceTraceableKnowledge: true,
    provenanceUntraceableKnowledge: true,
    originLinksByKind: true,
