...
const initialInstructionsByLocale: Record<SupportedLocale, string[]> = {
  ja: [
    ...
    "- `context_decision`: ブロッカー由来の判断が必要な時に、ユーザーへ質問する前の実行/修正/拒否/巻き戻し等を判断。",
  ...
  en: [
    ...
    "- `context_decision`: Resolves blocker-derived proceed/revise/reject/rollback/discard/escalate judgments before asking the user.",
