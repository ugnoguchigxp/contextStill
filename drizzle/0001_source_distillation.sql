CREATE TABLE IF NOT EXISTS "sources" (
  ...
  CONSTRAINT "sources_source_kind_check" CHECK ("source_kind" IN ('markdown','session','tool_output','git','web','manual'))
);
...
CREATE INDEX IF NOT EXISTS "sources_body_fts_idx" ON "sources" USING gin (to_tsvector('simple', "body"));

CREATE INDEX IF NOT EXISTS "source_fragments_source_id_idx" ON "source_fragments" ("source_id");
CREATE INDEX IF NOT EXISTS "source_fragments_source_locator_idx" ON "source_fragments" ("source_id", "locator");
CREATE INDEX IF NOT EXISTS "source_fragments_content_fts_idx" ON "source_fragments" USING gin (to_tsvector('simple', "content"));
...
CREATE INDEX IF NOT EXISTS "knowledge_source_links_knowledge_idx" ON "knowledge_source_links" ("knowledge_id");
CREATE INDEX IF NOT EXISTS "knowledge_source_links_source_fragment_idx" ON "knowledge_source_links" ("source_fragment_id");
CREATE INDEX IF NOT EXISTS "knowledge_source_links_link_type_idx" ON "knowledge_source_links" ("link_type");
