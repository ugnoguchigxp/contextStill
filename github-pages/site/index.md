---
layout: default
title: contextStill | Adaptive Knowledge Compiler
    ...
    <div class="shell">
      ...
      <div class="hero-grid">
        <div class="hero-copy">
          ...
          <p class="lead">
            contextStill は、Wiki・Web・コミット・Codex/Antigravity ログから
            再利用可能な <span class="mono">rule / procedure</span> を蒸留し、
            タスクごとに context pack を最適化する知識基盤です。
          </p>
          <div class="hero-actions">
            <a class="btn btn-primary" href="https://github.com/ugnoguchigxp/contextStill">GitHubで見る</a>
            <a class="btn btn-secondary" href="https://github.com/ugnoguchigxp/contextStill/blob/main/README.md">READMEを読む</a>
          </div>
  ...
  <section class="cta">
    <div class="shell">
      <div class="cta-panel">
        ...
        <a class="btn btn-primary" href="https://github.com/ugnoguchigxp/contextStill">GitHub プロジェクトを見る</a>
      </div>
    </div>
  </section>
</main>
