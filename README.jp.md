...
| `bun run distill:status` | distillation target queue と進捗を表示 |
...
| [Distillation Conveyor](docs/distillation-conveyor.md) | staged distillation queue と自動化フロー |
| [Candidate List UI Plan](docs/candidate-list-ui-plan.md) | candidate review API/UI の read model |
| [Cover Evidence Plan](docs/cover-evidence-plan.md) | evidence coverage と外部検証の設計 |
